...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("G:\\template");//这里写你自己的java目录
        ...
        dsc.setPassword("123456");/*192.168.101.202*/
        dsc.setUrl("jdbc:mysql://localhost:3306/zjsystem?serverTimezone=UTC");
        ...
        strategy.setInclude(new String[] {"course"});//需要生成的表
